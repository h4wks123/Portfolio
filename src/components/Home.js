  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center min-h-screen bg-cover bg-center bg-no-repeat relative bg-tier1">
        ...
        <div className="fixed bottom-80 right-44 w-[37.5%] h-[37.5%] transition-transform transform hover:scale-95">
          <svg
        ...
        <div className="fixed bottom-24 -right-40 w-[30%] h-[30%] transition-transform transform hover:scale-95">
          <svg
            className="drop-shadow-4xl"
            viewBox="0 0 84 84"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="fixed -top-16 -right-40 w-[30%] h-[30%] transition-transform transform hover:scale-95">
          <svg
            className="drop-shadow-4xl"
            viewBox="0 0 84 84"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="fixed bottom-14 left-44 w-[36%] h-[68%]">
          ...
          <div class="mb-8">
            ...
            <h1 className="text-tier2 font-light text-1xl mb-2">
              With a keen eye for detail and a dedication to lifelong learning,
              he is excited to
            </h1>
            <h1 className="text-tier2 font-light text-1xl mb-2">
          ...
          <div class="mb-6">
            ...
            >
              <Link to="/About" className="text-tier2 font-bold text-1xl">READ MORE</Link>
            </button>
          </div>

          {/* FOOTER DETAILS */}
          <div className="flex items-center">
            <span className="text-tier2 2xl font-semibold mr-4">
              Check out my
            </span>

            {/* FACEBOOK */}
            <a
              className="w-16 h-16 mr-4 transition-transform transform hover:scale-95"
              href="https://web.facebook.com/ivanne.bayer"
              target="_blank"
            ...
            <a
              className="w-16 h-16 mr-4 transition-transform transform hover:scale-95"
              href="https://www.instagram.com/h4wks123/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              className="w-16 h-16 mr-4 transition-transform transform hover:scale-95"
              href="https://twitter.com/ivannebayr"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
